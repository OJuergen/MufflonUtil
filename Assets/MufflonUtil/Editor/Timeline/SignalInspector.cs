...
namespace MufflonUtil
{
    ...
    {
        private readonly Dictionary<Component, bool> _foldouts = new Dictionary<Component, bool>();
        private readonly Dictionary<Component, Editor> _editors =
            new Dictionary<Component, Editor>();
        ...
        private Editor GetOrCreateEditor(Component c)
        {
            if (_editors.TryGetValue(c, out Editor editor))
            {
                return editor;
            }
