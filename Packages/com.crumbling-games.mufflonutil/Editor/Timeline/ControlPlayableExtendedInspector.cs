...
namespace MufflonUtil.Editor
{
    ...
    public class ControlPlayableExtendedInspector : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (playableAsset.prefabGameObject && GUILayout.Button("Convert to Embedded"))
            {
                Transform parent = !sourceGO ? null : sourceGO.transform;
